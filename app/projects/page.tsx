...
const projects = [
  {
    ...
    description: "Transformed a 15-acre overgrown lot into a development-ready site for a new residential subdivision.",
    challenge:
  ...
  },
  {
    ...
    challenge: "Existing access was inadequate for large delivery trucks and became impassable during wet weather.",
    solution:
  ...
  },
  {
    ...
    description: "Cleared overgrown areas around existing home to create usable yard space and reduce fire hazard.",
    challenge: "Heavy undergrowth and invasive species while maintaining privacy screening and mature shade trees.",
    solution:
  ...
  },
  {
    ...
    description: "Reclaimed abandoned farmland for return to agricultural use, including drainage improvements.",
    challenge: "Years of neglect had resulted in invasive species takeover and poor drainage affecting soil quality.",
    solution: "Comprehensive clearing followed by soil preparation and installation of agricultural drainage system.",
    results: [
            ...
            {projects.map((project, index) => (
              <div key={project.id} className="mx-auto max-w-6xl">
                <Card className="overflow-hidden">
                  <div
                    className={`grid grid-cols-1 gap-8 lg:grid-cols-2 ${index % 2 === 1 ? "lg:grid-flow-col-dense" : ""}`}
                  >
                    {/* Project Images */}
      ...
      <section className="py-24 bg-muted/30">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center mb-16">
            ...
            <p className="mt-4 text-lg text-muted-foreground">
              Real feedback from property owners who've experienced the B3 DEVELOPERS difference
            </p>
          </div>
          ...
          <div className="mx-auto grid max-w-6xl grid-cols-1 gap-8 lg:grid-cols-3">
            <Card>
              <CardContent className="p-8">
                ...
                <blockquote className="text-muted-foreground mb-4">
                  "B3 DEVELOPERS transformed our overgrown lot into a beautiful, buildable site. Their attention to
                  preserving the trees we wanted to keep was exceptional."
                </blockquote>
                <div className="text-sm">
                  <div className="font-semibold">Sarah Johnson</div>
                  <div className="text-muted-foreground">Residential Developer</div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-8">
                ...
                <blockquote className="text-muted-foreground mb-4">
                  "Professional, efficient, and reliable. They completed our commercial site preparation ahead of
                  schedule and under budget. Highly recommended."
                </blockquote>
                <div className="text-sm">
                  <div className="font-semibold">Mike Chen</div>
                  <div className="text-muted-foreground">Commercial Property Owner</div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-8">
                ...
                <blockquote className="text-muted-foreground mb-4">
                  "Their local knowledge made all the difference. They knew exactly how to handle our drainage issues
                  and soil conditions. Excellent work."
                </blockquote>
                <div className="text-sm">
