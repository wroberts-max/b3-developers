...
/** Service Area dialog used in the footer */
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8 min-h-[55vh]">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              ...
              {/* If your Button doesn't have an "inverted" variant, replace with: className="bg-white text-primary hover:bg-white/90" */}
