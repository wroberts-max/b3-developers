          ...
          <div className="mx-auto grid max-w-6xl grid-cols-1 gap-16 lg:grid-cols-2 lg:gap-24">
            <div>
              ...
              <p className="mt-4 text-muted-foreground">
                ...
                preparation. That's why we focus on doing things right the first time, using efficient, right-sized
                equipment that gets the job done without unnecessary damage or delays.
              </p>
              <p className="mt-4 text-muted-foreground">
